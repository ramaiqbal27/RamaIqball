document.addEventListener("DOMContentLoaded", function () {
  ...
  async function fetchData() {
      ...
      try {
          const contributorsResponse = await axios.get('https://api.github.com/repos/Tejashri-Taral/TrendTrove-Ecommerce/contributors');
          const contributorsData = contributorsResponse.data;

          const repoResponse = await axios.get('https://api.github.com/repos/Tejashri-Taral/TrendTrove-Ecommerce');
